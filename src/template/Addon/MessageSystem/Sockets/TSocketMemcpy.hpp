...
#define CreateTSocketMemcpy(Type, ControlledMember, StringClass, ID) dynamic_cast<ISocket*>(new TSocketMemcpy<float>(ControlledMember, StringClass::Strs[StringClass::ID], StringClass::ID))
